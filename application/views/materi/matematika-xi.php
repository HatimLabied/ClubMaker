...
<head>
    ...
    <title>Formation enregistré | Aeronotics :ClubMaker</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    <h1 class="display-4" data-aos="fade-down" data-aos-duration="1400">Veuillez sélectionner le cours que voullez 
                        vous apprenez!
                    </h1>
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                                                                        ...
                                                                        $this->session->userdata('email')])->row_array();
                                                                        echo $data['user']['nama'];
                                                                        ?>  :ClubMaker Students</h4>
                    <p>Formation enregistré | Aeronotics</p>
                    <hr width="80%">
                    <p data-aos="fade-down" class="font-weight-bold" data-aos-duration="1800">Veuillez sélectionner un cours
                        vous accéderez
                        en dessous de
                        cela!
                    </p>
                ...
                <div class="col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1200">
                    <div class="card materi w-150 border-0">
                        <div class="card-body p-5">
                            ...
                            <a href="<?php echo site_url('materi/belajar/' . $u->id); ?>" class="btn btn-white">Apprendre maintenant</a>
                        </div>
                    </div>
                </div>
            <?php } ?>

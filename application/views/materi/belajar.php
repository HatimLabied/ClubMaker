...
<body style="overflow-x:hidden;background-color:#fbf9fa">
    ...
    <div class="container" style="border: 2px solid red;padding: 10px;border-radius: 10px ;box-shadow: 10px 10px 5px grey;">
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 ml-4">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down" data-aos-duration="1400">Bonne étude!
                    </h1>
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                        ...
                        <p><?= $detail->nama_mapel ?> - Classe <?= $detail->kelas ?></p>
                        <hr align="left" width="600;">
                        <p style="line-height: 3px;">Nous allons apprendre davantage sur</p>
            ...
            <div class="col-md-12">
                <div class="card komen w-150 border-0">
                    <div class="card-body p-5" style="font-family: 'Poppins', sans-serif !important;">
                        <h1 style="color: black; font-size:44px !important;">Quel est votre commentaire?</h1>
                        <br>
                        <?php echo $disqus ?>
                    </div>
                </div>

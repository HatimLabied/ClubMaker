...
<head>
    ...
    <meta content="ClubMaker a été créé pour que les étudiants et les enseignants puissent continuer à apprendre et à enseigner n'importe où et n'importe quand." name="Description" />
    <meta content="ClubMaker, E-learning, Gratuit" name="keywords" />
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item" id="navtentang"><a class="nav-link" href="<?= base_url('welcome/tentang') ?>">À propos de nous</a></li>

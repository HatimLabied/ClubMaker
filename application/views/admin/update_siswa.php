...
<head>
    ...
    <title>Mettre à jour les données des étudiants :ClubMaker</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Mettre à jour les données des élèves</h2>
                                <hr>
                                <p class="card-text">lorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsum.
                                </p>
                    ...
                    <form action="<?= base_url('admin/user_edit') ?>" enctype="multipart/form-data" method="post">
                        <?php foreach ($user as $u) { ?>
                                ...
                                <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                                    ...
                                    <div class="input-group mt-3 mx-auto" style="width: 50%;">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="inputGroupFile01">Télécharger Photo</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                                <h1 class="font-weight-bold card-title text-center" style="color: black;">Télécharger les données
                                    de l'éleve 
                                </h1>
                                <p class="text-center" style="line-height: 5px;">Veuillez remplir les données ci-dessous pour mettre à jour
                                    données et téléchargez le fichier ci-dessus pour mettre à jour les données de la photo de profil</p>
                                <hr>
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1" class="font-weight-bold" style="font-size: 20px;">Nom</label>

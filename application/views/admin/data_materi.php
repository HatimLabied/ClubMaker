...
<head>
    ...
    <title>Données de cours :ClubMaker</title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;"> Gestion des données cours :ClubMaker</h2>
                            <hr>
                            <p class="card-text">lorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsum.</p>
                            <a href="<?= base_url('admin/tambah_materi') ?>" class="btn btn-success">Ajouter
                                Données de cours ⭢</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_materi/' . $u->id); ?>" class="btn btn-info">Mettre à jour ⭢</a>
                                ...
                                <p class="small font-weight-bold">Avant de télécharger des fichiers, vous devez d'abord
                                    config max_upload dans php.ini</p>
                            </div>
                        </div>
                    </div>
            </div>
    ...
    <?php if ($this->session->flashdata('success-edit')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Données du cours sont modifiées!',
    ...
    <?php if ($this->session->flashdata('user-delete')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Les données du cours sont supprimées!',
    ...
    <?php if ($this->session->flashdata('success-reg')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Données du cours ajoutées!',
                text: 'Félicitations, les données sont ajoutées!',
                showConfirmButton: false,
                timer: 2500
            })
        </script>

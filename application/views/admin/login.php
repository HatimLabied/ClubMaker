...
<head>
    ...
    <title>ClubMaker : Admin Login</title>
...
<body>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold text-white">Bienvenue!</h1>
                                <h5 class="font-weight-normal text-muted-transparent text-white">Veuillez vous connecter pour
                                    Entré dans
                                    page d'administration.</h5>
                            </div>
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb"
                                target="_blank" href="https://ensem.ac.ma/">Hatim LABIED & Ahmed EL MOUMIN</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    Swal.fire({
        icon: 'error',
        title: 'Sil vous plait Connectez-vous dabord!',

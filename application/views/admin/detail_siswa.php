...
<head>
    ...
    <title>Données détaillées sur les étudiants :ClubMaker </title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> lorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsum.
                                </p>
                        ...
                        <div class="col-md-12 bg-white p-3" id="detail" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            ...
                            <table style="width: 100%" class="container text-center">
                                <tbody>
                                    ...
                                    <tr style="border-bottom: 0.5px solid #6c757d;">
                                        <td><span class="font-weight-bold">Enregistré le :</span></td>

...
<head>
    ...
    <title>Données de l'enseignant: ClubMaker</title>
    <!-- General CSS Files -->
...
<body>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard-teacher"></i>
                                <span>Profs</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/data_guru') ?>">Données du prof</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('admin/add_guru') ?>">Ajouter du prof</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Gestion des données des enseignants ClubMaker</h2>
                            <hr>
                            ...
                            <a href="<?= base_url('admin/add_guru') ?>" class="btn btn-success">Ajouter
                                Données de l'enseignant ⭢</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_guru/' . $u->nip); ?>" class="btn btn-info">Mettre à jour ⭢</a>
                                    ...
                                    <p class="small font-weight-bold">L'inscription des enseignants ne peut être effectuée que par l'administrateur et ne peut pas être effectuée seule</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <?php if ($this->session->flashdata('success-edit')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Les données des enseignants sont changés!',
                text: 'Félicitations, les données sont changée!',
    ...
    <?php if ($this->session->flashdata('user-delete')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Les données des enseignants sont effacées!',

...
<head>
    ...
    <title>Données détaillées de l'enseignant: ClubMaker </title>
    <!-- General CSS Files -->
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Détails de l'enseignant | <?= $detail->nama_guru ?> </h2>
                            <hr>
                            <p class="card-text">lorum impsonlorum impsonlorum impsonlorum impsonlorum impsonlorum impsonlorum impsonlorum impsonlorum impsonlorum impsonlorum impson.
                            </p>
                    ...
                    <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                        <h1 class="font-weight-bold card-title text-center" style="color: black;">Détails de l'enseignant </h1>
                        <p class="text-center" style="line-height: 5px;">Voici les données détaillées contenues dans
                            base de données, y compris Num, nom, e-mail
                            et Mapel qui a appris.</p>
                        <hr>
                        <table style="width: 100%" class="container text-center">
                            <tbody>
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Numéro d'identification du prof:</span></td>
                                    <td> <?= $detail->nip ?></td>
                                </tr>
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Nom de l'enseignant :</span></td>
                                ...
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Sujets :</span></td>
                        ...
                        <a href="<?= base_url('admin/data_guru') ?>" class="btn btn-success btn-block">Retour</a>
                    </div>
                </section>
            </div>
        </div>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2021 <div class="bullet"></div><a href="https://ensem.ac.ma">Hatim LABIED et Ahmed ELMOUMIN</a>
        </div>
    </footer>
    <!-- End Footer -->

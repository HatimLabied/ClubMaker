                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Mise à jour des données matières</h2>
                                <hr>
                    ...
                    <div class="card card-success">
                        <div class="col-md-12 text-center">
                            ...
                            Mise à jour des données matières</p>
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('admin/materi_edit') ?>">
                                    ...
                                    <div class="form-group">
                                        <label for="nip">Nom de l'enseignant</label>
                                    ...
                                    <div class="form-group">
                                        <label for="nama_mapel">Sujets</label>

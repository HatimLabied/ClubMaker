...
<head>
    ...
    <title>Données des étudiants :ClubMaker</title>
    <!-- General CSS Files -->
...
<body>
        ...
        <div class="main-wrapper">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('admin') ?>">CMsup>2021</sup></a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/add_guru') ?>">Ajouter des données profs</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/tambah_materi') ?>">Ajouter de cours</a>
                                </li>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Gestion des données d'apprentissage des étudiants</h2>
                            <hr>
                            <p class="card-text"> lorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsum. </p>
                            <a href="<?= base_url('user/registration') ?>" class="btn btn-success">Ajouter
                        ...
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                                <div class="table-responsive">
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/detail_siswa/' . $u->id); ?>" class="btn btn-success">Détail ⭢</a>
                                                    </td>

                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_siswa/' . $u->id); ?>" class="btn btn-info">Mettre à jour ⭢</a>

                                                        <a href="<?php echo site_url('admin/delete_siswa/' . $u->id); ?>" class="btn btn-danger remove">Supprimer✖</a>
                                                    </td>
                                    ...
                                    <p class="small font-weight-bold">* Le numéro 1 indique que le compte a été actif entre-temps
                                        Nombres
                                        0 indique le compte
                                        pas encore
                                        actif</p>
    ...
    <?php if ($this->session->flashdata('success-edit')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Les données des étudiants sont modifiées!',
                text: 'Félicitations, les données sont changé!',

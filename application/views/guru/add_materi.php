...
<head>
    <meta charset="utf-8" />
    <title>ClubMaker - Ajouter des cours</title>
                                    ...
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a href="#"
                                                class="kt-menu__link "><i
                                                    ...
                                                    class="kt-menu__link-text">Théorie</span></a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                                        ...
                                        <ul class="kt-menu__subnav">
                                            <li class="kt-menu__item " aria-haspopup="true"><a href="javascript:;"
                                                    class="kt-menu__link "><i
                                                        ...
                                                        class="kt-menu__link-text">Ajouter le cours</span></a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
...
echo $data['user']['nama_guru'];?>" class="form-control" id="inputEmail4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Nom du sujet</label>
...
echo $data['user']['nama_mapel'];?>" class="form-control" id="inputEmail4">
                                    ...
                                    <button type="submit" class="btn btn-success">Ajouter du cours</button>
                            </div>
                        </div>

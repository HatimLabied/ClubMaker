...
<head>
    <meta charset="utf-8" />
    <title>ClubMaker : Page Professeur</title>
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                    data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                        class="kt-menu__link kt-menu__toggle"><span
                                            class="kt-menu__link-text">cours</span><i
                                        ...
                                        <ul class="kt-menu__subnav">
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="<?=base_url('guru/add_materi')?>" class="kt-menu__link "><i
                                                        ...
                                                        class="kt-menu__link-text">Ajouter cours</span></a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="kt-header__topbar">
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--user">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                ...
                                <span class="kt-hidden kt-header__topbar-username">pseudo</span>
                                ...
                                <div class="kt-notification">
                                    <a href="<?=base_url('guru/add_materi')?>" class="kt-notification__item">
                                        ...
                                        <div class="kt-notification__item-details">
                                            ...
                                            Ajouter des données cours
                                            </div>
                                            <div class="kt-notification__item-time">
                                            Ajouter la  cours ClubMaker
                                            </div>
                                        </div>
                                    </a>
                                    <div class="kt-notification__custom">
                                        <a href="<?=base_url('welcome/logout')?>"
                                            class="btn btn-label-brand btn-sm btn-bold">Se déconnecter</a>
                                    </div>
                                </div>
...
?> !
                                            ...
                                            <div class="kt-widget19__labels">
                                                <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">ClubMaker</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            Bienvenue sur la page des enseignants ClubMaker, où vous pouvez ajouter du cours.
                                                Dans le cours, vous pouvez inclure une vidéo et une description de celle-ci. J'espère que vous êtes
                                                Profitez de Learnify!, Contactez l'administrateur en cas de problème
                                                tout ce qui concerne le téléchargement de cours. Merci d'utiliser
                                                apprenez!
                                                <br>
                                                Bon travail :)
                                            </div>
                                        ...
                                        <div class="kt-widget19__action">
                                            <a href="#" class="btn btn-sm btn-label-brand btn-bold">Ajouter le cours</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                            <div class="kt-footer__copyright">
                                2021&nbsp;&copy;&nbsp;<a href="https://ensem.ac.ma/" target="_blank"
                                    class="kt-link">ENSEM</a>
                            </div>
            ...
            <div id="kt_quick_panel" class="kt-quick-panel">
                ...
                <div class="kt-quick-panel__nav">
                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand  kt-notification-item-padding-x"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_quick_panel_tab_logs" role="tab">Journaux d'audit</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#kt_quick_panel_tab_settings"
                                role="tab">Parrametres</a>
                        </li>
                    </ul>
                </div>
                <div class="kt-quick-panel__content">
                    <div class="tab-content">
                        <div class="tab-pane fade show kt-scroll active" id="kt_quick_panel_tab_notifications"
                            ...
                            <div class="kt-notification">
                                ...
                                <a href="#" class="kt-notification__item">
                                    ...
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                                        Le nouveau client est enregistré
                                        </div>
                                        <div class="kt-notification__item-time">
                                        Il y a 3 heures
                                        </div>
                                ...
                                <a href="#" class="kt-notification__item">
                                    ...
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                                        Nouveaux commentaires d'utilisateurs reçus
                                        </div>
                                        <div class="kt-notification__item-time">
                                        Il y a 8 heures
                                        </div>
                                ...
                                <a href="#" class="kt-notification__item">
                                    ...
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                                            Le redémarrage du système a été effectué avec succès
                                        </div>
                                        <div class="kt-notification__item-time">
                                        Il y a 12 heures
                                        </div>
                                ...
                                <a href="#" class="kt-notification__item">
                                    ...
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                                        Les rapports financiers ont été générés
                                        </div>
                                        <div class="kt-notification__item-time">
                                        Il y a 25 heures
                                        </div>
                                ...
                                <a href="#" class="kt-notification__item">
                                    ...
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                                            Nouveau commentaire client reçu
                                        </div>
                                        <div class="kt-notification__item-time">
                                        Il y a 2 jours
                                        </div>
                            ...
                            <div class="kt-notification-v2">
                                <a href="#" class="kt-notification-v2__item">
                                    ...
                                    <div class="kt-notification-v2__itek-wrapper">
                                        ...
                                        5 nouveaux rapports générés par les utilisateurs
                                        </div>
                                        <div class="kt-notification-v2__item-desc">
                                        Rapports basés sur les ventes
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="kt-notification-v2__item">
                                ...
                                <a href="#" class="kt-notification-v2__item">
                                    ...
                                    <div class="kt-notification-v2__itek-wrapper">
                                        <div class="kt-notification-v2__item-title">
                                            Temps de réponse moyen de 4,5 heures
                                        </div>
                                        <div class="kt-notification-v2__item-desc">
                                        Le plus rapide est Hatim
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="kt-notification-v2__item">
                                ...
                                <a href="#" class="kt-notification-v2__item">
                                    ...
                                    <div class="kt-notification-v2__itek-wrapper">
                                        <div class="kt-notification-v2__item-title">
                                        Le rapport système a été généré
                                        </div>
                                        <div class="kt-notification-v2__item-desc">
                                        Le plus rapide est LABIED
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="kt-notification-v2__item">
                                    ...
                                    <div class="kt-notification-v2__itek-wrapper">
                                        ...
                                        <div class="kt-notification-v2__item-desc">
                                        Le plus rapide est HATIM labied
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="tab-pane kt-quick-panel__content-padding-x fade kt-scroll"
                            ...
                            <form class="kt-form">
                                <div class="kt-heading kt-heading--sm kt-heading--space-sm">Service client</div>
                                <div class="form-group form-group-xs row">
                                    <label class="col-8 col-form-label">Activer les notifications:</label>
                                ...
                                <div class="form-group form-group-xs row">
                                    <label class="col-8 col-form-label">Activer le suivi des cas:</label>
                                    <div class="col-4 kt-align-right">
                                        <span class="kt-switch kt-switch--success kt-switch--sm">
                                            <label>
                                ...
                                <div class="form-group form-group-last form-group-xs row">
                                    <label class="col-8 col-form-label">Portail d'assistance:</label>
                                    <div class="col-4 kt-align-right">
                                        <span class="kt-switch kt-switch--success kt-switch--sm">
                                            <label>
                                                <input type="checkbox" checked="checked"
                                ...
                                <div class="kt-heading kt-heading--sm kt-heading--space-sm">Rapports</div>
                                <div class="form-group form-group-xs row">
                                    <label class="col-8 col-form-label">Générer des rapports:</label>
                                    <div class="col-4 kt-align-right">
                                ...
                                <div class="form-group form-group-xs row">
                                    <label class="col-8 col-form-label">Activer l'exportation de rapport:</label>
                                    <div class="col-4 kt-align-right">
                                        <span class="kt-switch kt-switch--sm kt-switch--danger">
                                            <label>
                                ...
                                <div class="form-group form-group-last form-group-xs row">
                                    <label class="col-8 col-form-label">Autoriser la collecte de données:</label>
                                    <div class="col-4 kt-align-right">
                                        <span class="kt-switch kt-switch--sm kt-switch--danger">
                                            <label>
                                                <input type="checkbox" checked="checked"
                                ...
                                <div class="form-group form-group-xs row">
                                    <label class="col-8 col-form-label">Activer l'inscription des membres:</label>
                                    <div class="col-4 kt-align-right">
                                ...
                                <div class="form-group form-group-xs row">
                                    <label class="col-8 col-form-label">Autoriser les commentaires des utilisateurs:</label>
                                    <div class="col-4 kt-align-right">
                                        <span class="kt-switch kt-switch--sm kt-switch--brand">
                                            <label>
                                ...
                                <div class="form-group form-group-last form-group-xs row">
                                    <label class="col-8 col-form-label">Activer le portail client:</label>
                                    <div class="col-4 kt-align-right">
                                        <span class="kt-switch kt-switch--sm kt-switch--brand">
                                            <label>
                                                <input type="checkbox" checked="checked"
            ...
            Swal.fire({
                icon: 'success',
                title: 'cours ajouté!',
                text: 'Félicitations,les données sont bien ajoutés!',
            ...
            Swal.fire({
                icon: 'success',
                title: 'Les données des étudiants sont supprimées!',
                text: 'Félicitations, les données sont supprimées!',
                showConfirmButton: false,
                timer: 2500
            })
            </script>

...
<head>
    ...
    <title>Ajouter des données d'enseignant : ClubMaker</title>
    <!-- General CSS Files -->
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="menu-header">Gestion des professeur</li>
                        <li class="nav-item dropdown active">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard-teacher"></i>
                                <span>Profs</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/data_guru') ?>">données des profs</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('admin/add_guru') ?>">Ajouter des données des profs</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/tambah_materi') ?>">Ajouter cours</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">lorum arupsolorum arupso lorum arupso lorum arupso lorum arupso lorum arupso lorum arupso . 
                                </p>
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= base_url('admin/add_guru') ?>">
                                <div id="" class="form-group">
                                    <label for="nip">Numéro d'identification de l'employé</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="password2" class="d-block">Confirmez le mot de passe</label>
                                ...
                                <div id="" class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <select class="form-control selectric" name="mapel">
                                            <option>Formation enregistré</option>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="agree">Je comprends et je veux
                                            Continuez.</label>
                                    </div>
                                </div>
